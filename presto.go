...
func (p PrestoThriftBound) String() string {
	switch p {
	case PrestoThriftBound_BELOW:
		return "BELOW"
	case PrestoThriftBound_EXACTLY:
		return "EXACTLY"
	case PrestoThriftBound_ABOVE:
		return "ABOVE"
	}
	return "<UNSET>"
}
...
func PrestoThriftBoundFromString(s string) (PrestoThriftBound, error) {
	switch s {
	case "BELOW":
		return PrestoThriftBound_BELOW, nil
	case "EXACTLY":
		return PrestoThriftBound_EXACTLY, nil
	case "ABOVE":
		return PrestoThriftBound_ABOVE, nil
	}
...
//  - Columns
//  - Comment
//  - IndexableKeys: Returns a list of key sets which can be used for index lookups.
...
type PrestoThriftTableMetadata struct {
	...
	IndexableKeys   [][]string                    `thrift:"indexableKeys,4" db:"indexableKeys" json:"indexableKeys,omitempty"`
}
...
var PrestoThriftTableMetadata_IndexableKeys_DEFAULT [][]string

func (p *PrestoThriftTableMetadata) GetIndexableKeys() [][]string {
	return p.IndexableKeys
}
...
func (p *PrestoThriftTableMetadata) IsSetIndexableKeys() bool {
	return p.IndexableKeys != nil
}
...
func (p *PrestoThriftTableMetadata) ReadField2(iprot thrift.TProtocol) error {
	...
	p.Columns = tSlice
	for i := 0; i < size; i++ {
		_elem0 := &PrestoThriftColumnMetadata{}
...
func (p *PrestoThriftTableMetadata) ReadField4(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return thrift.PrependError("error reading list begin: ", err)
	}
	tSlice := make([][]string, 0, size)
	p.IndexableKeys = tSlice
	for i := 0; i < size; i++ {
		...
		p.IndexableKeys = append(p.IndexableKeys, _elem1)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *PrestoThriftTableMetadata) writeField4(oprot thrift.TProtocol) (err error) {
	if p.IsSetIndexableKeys() {
		if err := oprot.WriteFieldBegin("indexableKeys", thrift.LIST, 4); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:indexableKeys: ", p), err)
		}
		if err := oprot.WriteListBegin(thrift.SET, len(p.IndexableKeys)); err != nil {
			return thrift.PrependError("error writing list begin: ", err)
		}
		for _, v := range p.IndexableKeys {
		...
		if err := oprot.WriteFieldEnd(); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field end error 4:indexableKeys: ", p), err)
		}
	}
	return err
}
...
type PrestoThriftEquatableValueSet struct {
	Inclusive bool                 `thrift:"inclusive,1" db:"inclusive" json:"inclusive"`
...
func (p *PrestoThriftEquatableValueSet) GetInclusive() bool {
	return p.Inclusive
}
...
func (p *PrestoThriftEquatableValueSet) writeField1(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("inclusive", thrift.BOOL, 1); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:inclusive: ", p), err)
	}
	if err := oprot.WriteBool(bool(p.Inclusive)); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T.inclusive (1) field write error: ", p), err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field end error 1:inclusive: ", p), err)
	}
	return err
}
...
func (p *PrestoThriftBigint) ReadField2(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Longs = append(p.Longs, _elem10)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *PrestoThriftDouble) ReadField2(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Doubles = append(p.Doubles, _elem12)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *PrestoThriftVarchar) ReadField2(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Sizes = append(p.Sizes, _elem14)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *PrestoThriftBoolean) ReadField2(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Booleans = append(p.Booleans, _elem16)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *PrestoThriftDate) ReadField2(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Dates = append(p.Dates, _elem18)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *PrestoThriftTimestamp) ReadField2(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Timestamps = append(p.Timestamps, _elem20)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *PrestoThriftJson) ReadField1(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Nulls = append(p.Nulls, _elem21)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *PrestoThriftJson) ReadField2(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Sizes = append(p.Sizes, _elem22)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *PrestoThriftHyperLogLog) ReadField1(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Nulls = append(p.Nulls, _elem23)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *PrestoThriftHyperLogLog) ReadField2(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Sizes = append(p.Sizes, _elem24)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *PrestoThriftBigintArray) ReadField1(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Nulls = append(p.Nulls, _elem25)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *PrestoThriftBigintArray) ReadField2(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Sizes = append(p.Sizes, _elem26)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
// Attributes:
//  - SplitId: Encodes all the information needed to identify a batch of rows to return to Presto.
...
//  - Hosts: Identifies the set of hosts on which the rows are available. If empty, then the rows
...
func (p *PrestoThriftSplit) ReadField2(iprot thrift.TProtocol) error {
	...
	p.Hosts = tSlice
	for i := 0; i < size; i++ {
		_elem29 := &PrestoThriftHostAddress{}
...
type PrestoThriftService interface { //Presto Thrift service definition.
	...
	//  - MaxSplitCount
	//  - NextToken
	PrestoGetIndexSplits(ctx context.Context, schemaTableName *PrestoThriftSchemaTableName, indexColumnNames []string, outputColumnNames []string, keys *PrestoThriftPageResult_, outputConstraint *PrestoThriftTupleDomain, maxSplitCount int32, nextToken *PrestoThriftNullableToken) (r *PrestoThriftSplitBatch, err error)
...
func NewPrestoThriftServiceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *PrestoThriftServiceClient {
	return &PrestoThriftServiceClient{
...
func NewPrestoThriftServiceClient(c thrift.TClient) *PrestoThriftServiceClient {
	return &PrestoThriftServiceClient{
		c: c,
	}
}

func (p *PrestoThriftServiceClient) Client_() thrift.TClient {
	return p.c
}

// Returns available schema names.
func (p *PrestoThriftServiceClient) PrestoListSchemaNames(ctx context.Context) (r []string, err error) {
	var _args31 PrestoThriftServicePrestoListSchemaNamesArgs
	var _result32 PrestoThriftServicePrestoListSchemaNamesResult
	if err = p.Client_().Call(ctx, "prestoListSchemaNames", &_args31, &_result32); err != nil {
		return
	}
	switch {
	case _result32.Ex1 != nil:
		return r, _result32.Ex1
	}
...
func (p *PrestoThriftServiceClient) PrestoListTables(ctx context.Context, schemaNameOrNull *PrestoThriftNullableSchemaName) (r []*PrestoThriftSchemaTableName, err error) {
	var _args33 PrestoThriftServicePrestoListTablesArgs
	_args33.SchemaNameOrNull = schemaNameOrNull
	var _result34 PrestoThriftServicePrestoListTablesResult
	if err = p.Client_().Call(ctx, "prestoListTables", &_args33, &_result34); err != nil {
		return
	}
	switch {
	case _result34.Ex1 != nil:
		return r, _result34.Ex1
	}
...
func (p *PrestoThriftServiceClient) PrestoGetTableMetadata(ctx context.Context, schemaTableName *PrestoThriftSchemaTableName) (r *PrestoThriftNullableTableMetadata, err error) {
	var _args35 PrestoThriftServicePrestoGetTableMetadataArgs
	_args35.SchemaTableName = schemaTableName
	var _result36 PrestoThriftServicePrestoGetTableMetadataResult
	if err = p.Client_().Call(ctx, "prestoGetTableMetadata", &_args35, &_result36); err != nil {
		return
	}
	switch {
	case _result36.Ex1 != nil:
		return r, _result36.Ex1
	}
...
func (p *PrestoThriftServiceClient) PrestoGetSplits(ctx context.Context, schemaTableName *PrestoThriftSchemaTableName, desiredColumns *PrestoThriftNullableColumnSet, outputConstraint *PrestoThriftTupleDomain, maxSplitCount int32, nextToken *PrestoThriftNullableToken) (r *PrestoThriftSplitBatch, err error) {
	var _args37 PrestoThriftServicePrestoGetSplitsArgs
	_args37.SchemaTableName = schemaTableName
	_args37.DesiredColumns = desiredColumns
	_args37.OutputConstraint = outputConstraint
	_args37.MaxSplitCount = maxSplitCount
	_args37.NextToken = nextToken
	var _result38 PrestoThriftServicePrestoGetSplitsResult
	if err = p.Client_().Call(ctx, "prestoGetSplits", &_args37, &_result38); err != nil {
		return
	}
	switch {
	case _result38.Ex1 != nil:
		return r, _result38.Ex1
	}
...
//  - MaxSplitCount
//  - NextToken
func (p *PrestoThriftServiceClient) PrestoGetIndexSplits(ctx context.Context, schemaTableName *PrestoThriftSchemaTableName, indexColumnNames []string, outputColumnNames []string, keys *PrestoThriftPageResult_, outputConstraint *PrestoThriftTupleDomain, maxSplitCount int32, nextToken *PrestoThriftNullableToken) (r *PrestoThriftSplitBatch, err error) {
	var _args39 PrestoThriftServicePrestoGetIndexSplitsArgs
	_args39.SchemaTableName = schemaTableName
	_args39.IndexColumnNames = indexColumnNames
	_args39.OutputColumnNames = outputColumnNames
	_args39.Keys = keys
	_args39.OutputConstraint = outputConstraint
	_args39.MaxSplitCount = maxSplitCount
	_args39.NextToken = nextToken
	var _result40 PrestoThriftServicePrestoGetIndexSplitsResult
	if err = p.Client_().Call(ctx, "prestoGetIndexSplits", &_args39, &_result40); err != nil {
		return
	}
	switch {
	case _result40.Ex1 != nil:
		return r, _result40.Ex1
	}
...
func (p *PrestoThriftServiceClient) PrestoGetRows(ctx context.Context, splitId *PrestoThriftId, columns []string, maxBytes int64, nextToken *PrestoThriftNullableToken) (r *PrestoThriftPageResult_, err error) {
	var _args41 PrestoThriftServicePrestoGetRowsArgs
	_args41.SplitId = splitId
	_args41.Columns = columns
	_args41.MaxBytes = maxBytes
	_args41.NextToken = nextToken
	var _result42 PrestoThriftServicePrestoGetRowsResult
	if err = p.Client_().Call(ctx, "prestoGetRows", &_args41, &_result42); err != nil {
		return
	}
	switch {
	case _result42.Ex1 != nil:
		return r, _result42.Ex1
	}
...
func NewPrestoThriftServiceProcessor(handler PrestoThriftService) *PrestoThriftServiceProcessor {
	...
	self43 := &PrestoThriftServiceProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self43.processorMap["prestoListSchemaNames"] = &prestoThriftServiceProcessorPrestoListSchemaNames{handler: handler}
	self43.processorMap["prestoListTables"] = &prestoThriftServiceProcessorPrestoListTables{handler: handler}
	self43.processorMap["prestoGetTableMetadata"] = &prestoThriftServiceProcessorPrestoGetTableMetadata{handler: handler}
	self43.processorMap["prestoGetSplits"] = &prestoThriftServiceProcessorPrestoGetSplits{handler: handler}
	self43.processorMap["prestoGetIndexSplits"] = &prestoThriftServiceProcessorPrestoGetIndexSplits{handler: handler}
	self43.processorMap["prestoGetRows"] = &prestoThriftServiceProcessorPrestoGetRows{handler: handler}
	return self43
}
...
type prestoThriftServiceProcessorPrestoGetIndexSplits struct {
	handler PrestoThriftService
}

func (p *prestoThriftServiceProcessorPrestoGetIndexSplits) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := PrestoThriftServicePrestoGetIndexSplitsArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("prestoGetIndexSplits", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	result := PrestoThriftServicePrestoGetIndexSplitsResult{}
	var retval *PrestoThriftSplitBatch
	var err2 error
	if retval, err2 = p.handler.PrestoGetIndexSplits(ctx, args.SchemaTableName, args.IndexColumnNames, args.OutputColumnNames, args.Keys, args.OutputConstraint, args.MaxSplitCount, args.NextToken); err2 != nil {
		switch v := err2.(type) {
		case *PrestoThriftServiceException:
			result.Ex1 = v
		default:
			x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing prestoGetIndexSplits: "+err2.Error())
			oprot.WriteMessageBegin("prestoGetIndexSplits", thrift.EXCEPTION, seqId)
			x.Write(oprot)
			oprot.WriteMessageEnd()
			oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("prestoGetIndexSplits", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
func (p *PrestoThriftServicePrestoListTablesResult) ReadField0(iprot thrift.TProtocol) error {
	...
	p.Success = tSlice
	for i := 0; i < size; i++ {
		_elem46 := &PrestoThriftSchemaTableName{}
...
//  - MaxSplitCount
//  - NextToken
type PrestoThriftServicePrestoGetIndexSplitsArgs struct {
	SchemaTableName   *PrestoThriftSchemaTableName `thrift:"schemaTableName,1" db:"schemaTableName" json:"schemaTableName"`
	IndexColumnNames  []string                     `thrift:"indexColumnNames,2" db:"indexColumnNames" json:"indexColumnNames"`
	OutputColumnNames []string                     `thrift:"outputColumnNames,3" db:"outputColumnNames" json:"outputColumnNames"`
	Keys              *PrestoThriftPageResult_     `thrift:"keys,4" db:"keys" json:"keys"`
	OutputConstraint  *PrestoThriftTupleDomain     `thrift:"outputConstraint,5" db:"outputConstraint" json:"outputConstraint"`
	MaxSplitCount     int32                        `thrift:"maxSplitCount,6" db:"maxSplitCount" json:"maxSplitCount"`
	NextToken         *PrestoThriftNullableToken   `thrift:"nextToken,7" db:"nextToken" json:"nextToken"`
}

func NewPrestoThriftServicePrestoGetIndexSplitsArgs() *PrestoThriftServicePrestoGetIndexSplitsArgs {
	return &PrestoThriftServicePrestoGetIndexSplitsArgs{}
}

var PrestoThriftServicePrestoGetIndexSplitsArgs_SchemaTableName_DEFAULT *PrestoThriftSchemaTableName

func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) GetSchemaTableName() *PrestoThriftSchemaTableName {
	if !p.IsSetSchemaTableName() {
		return PrestoThriftServicePrestoGetIndexSplitsArgs_SchemaTableName_DEFAULT
	}
	return p.SchemaTableName
}

func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) GetIndexColumnNames() []string {
	return p.IndexColumnNames
}

func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) GetOutputColumnNames() []string {
	return p.OutputColumnNames
}

var PrestoThriftServicePrestoGetIndexSplitsArgs_Keys_DEFAULT *PrestoThriftPageResult_

func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) GetKeys() *PrestoThriftPageResult_ {
	if !p.IsSetKeys() {
		return PrestoThriftServicePrestoGetIndexSplitsArgs_Keys_DEFAULT
	}
	return p.Keys
}

var PrestoThriftServicePrestoGetIndexSplitsArgs_OutputConstraint_DEFAULT *PrestoThriftTupleDomain

func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) GetOutputConstraint() *PrestoThriftTupleDomain {
	if !p.IsSetOutputConstraint() {
		return PrestoThriftServicePrestoGetIndexSplitsArgs_OutputConstraint_DEFAULT
	}
	return p.OutputConstraint
}

func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) GetMaxSplitCount() int32 {
	return p.MaxSplitCount
}

var PrestoThriftServicePrestoGetIndexSplitsArgs_NextToken_DEFAULT *PrestoThriftNullableToken

func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) GetNextToken() *PrestoThriftNullableToken {
	if !p.IsSetNextToken() {
		return PrestoThriftServicePrestoGetIndexSplitsArgs_NextToken_DEFAULT
	}
	return p.NextToken
}
func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) IsSetSchemaTableName() bool {
	return p.SchemaTableName != nil
}

func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) IsSetKeys() bool {
	return p.Keys != nil
}

func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) IsSetOutputConstraint() bool {
	return p.OutputConstraint != nil
}

func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) IsSetNextToken() bool {
	return p.NextToken != nil
}

func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) ReadField1(iprot thrift.TProtocol) error {
	p.SchemaTableName = &PrestoThriftSchemaTableName{}
	if err := p.SchemaTableName.Read(iprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.SchemaTableName), err)
	}
...
func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) ReadField2(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return thrift.PrependError("error reading list begin: ", err)
	}
	tSlice := make([]string, 0, size)
	p.IndexColumnNames = tSlice
	for i := 0; i < size; i++ {
		var _elem47 string
		if v, err := iprot.ReadString(); err != nil {
			return thrift.PrependError("error reading field 0: ", err)
		...
		p.IndexColumnNames = append(p.IndexColumnNames, _elem47)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) ReadField3(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return thrift.PrependError("error reading list begin: ", err)
	}
	tSlice := make([]string, 0, size)
	p.OutputColumnNames = tSlice
	for i := 0; i < size; i++ {
		var _elem48 string
		if v, err := iprot.ReadString(); err != nil {
			return thrift.PrependError("error reading field 0: ", err)
		...
		p.OutputColumnNames = append(p.OutputColumnNames, _elem48)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) ReadField4(iprot thrift.TProtocol) error {
	p.Keys = &PrestoThriftPageResult_{}
...
func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) ReadField5(iprot thrift.TProtocol) error {
	p.OutputConstraint = &PrestoThriftTupleDomain{}
	if err := p.OutputConstraint.Read(iprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.OutputConstraint), err)
	}
...
func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) ReadField6(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI32(); err != nil {
...
func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) ReadField7(iprot thrift.TProtocol) error {
	p.NextToken = &PrestoThriftNullableToken{}
	if err := p.NextToken.Read(iprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.NextToken), err)
	}
...
func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) Write(oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin("prestoGetIndexSplits_args"); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err)
	}
	if p != nil {
		if err := p.writeField1(oprot); err != nil {
...
func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("schemaTableName", thrift.STRUCT, 1); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:schemaTableName: ", p), err)
	}
	if err := p.SchemaTableName.Write(oprot); err != nil {
...
func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) writeField2(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("indexColumnNames", thrift.LIST, 2); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:indexColumnNames: ", p), err)
	}
	if err := oprot.WriteListBegin(thrift.STRING, len(p.IndexColumnNames)); err != nil {
		return thrift.PrependError("error writing list begin: ", err)
	}
	for _, v := range p.IndexColumnNames {
		if err := oprot.WriteString(string(v)); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T. (0) field write error: ", p), err)
		}
	}
	...
	if err := oprot.WriteFieldEnd(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field end error 2:indexColumnNames: ", p), err)
	}
	return err
}

func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) writeField3(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("outputColumnNames", thrift.LIST, 3); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:outputColumnNames: ", p), err)
	}
	if err := oprot.WriteListBegin(thrift.STRING, len(p.OutputColumnNames)); err != nil {
		return thrift.PrependError("error writing list begin: ", err)
	}
	for _, v := range p.OutputColumnNames {
		if err := oprot.WriteString(string(v)); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T. (0) field write error: ", p), err)
		}
	}
	...
	if err := oprot.WriteFieldEnd(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field end error 3:outputColumnNames: ", p), err)
	}
	return err
}

func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) writeField4(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("keys", thrift.STRUCT, 4); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:keys: ", p), err)
	}
	if err := p.Keys.Write(oprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error writing struct: ", p.Keys), err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field end error 4:keys: ", p), err)
	}
	return err
}

func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) writeField5(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("outputConstraint", thrift.STRUCT, 5); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 5:outputConstraint: ", p), err)
	}
	if err := p.OutputConstraint.Write(oprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error writing struct: ", p.OutputConstraint), err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field end error 5:outputConstraint: ", p), err)
	}
	return err
}

func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) writeField6(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("maxSplitCount", thrift.I32, 6); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 6:maxSplitCount: ", p), err)
	}
	if err := oprot.WriteI32(int32(p.MaxSplitCount)); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T.maxSplitCount (6) field write error: ", p), err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field end error 6:maxSplitCount: ", p), err)
	}
	return err
}

func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) writeField7(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("nextToken", thrift.STRUCT, 7); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 7:nextToken: ", p), err)
	}
	if err := p.NextToken.Write(oprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error writing struct: ", p.NextToken), err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field end error 7:nextToken: ", p), err)
	}
	return err
}

func (p *PrestoThriftServicePrestoGetIndexSplitsArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("PrestoThriftServicePrestoGetIndexSplitsArgs(%+v)", *p)
}

// Attributes:
//  - Success
//  - Ex1
type PrestoThriftServicePrestoGetIndexSplitsResult struct {
	Success *PrestoThriftSplitBatch       `thrift:"success,0" db:"success" json:"success,omitempty"`
	Ex1     *PrestoThriftServiceException `thrift:"ex1,1" db:"ex1" json:"ex1,omitempty"`
}

func NewPrestoThriftServicePrestoGetIndexSplitsResult() *PrestoThriftServicePrestoGetIndexSplitsResult {
	return &PrestoThriftServicePrestoGetIndexSplitsResult{}
}

var PrestoThriftServicePrestoGetIndexSplitsResult_Success_DEFAULT *PrestoThriftSplitBatch

func (p *PrestoThriftServicePrestoGetIndexSplitsResult) GetSuccess() *PrestoThriftSplitBatch {
	if !p.IsSetSuccess() {
		return PrestoThriftServicePrestoGetIndexSplitsResult_Success_DEFAULT
	}
	return p.Success
}

var PrestoThriftServicePrestoGetIndexSplitsResult_Ex1_DEFAULT *PrestoThriftServiceException

func (p *PrestoThriftServicePrestoGetIndexSplitsResult) GetEx1() *PrestoThriftServiceException {
	if !p.IsSetEx1() {
		return PrestoThriftServicePrestoGetIndexSplitsResult_Ex1_DEFAULT
	}
	return p.Ex1
}
func (p *PrestoThriftServicePrestoGetIndexSplitsResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *PrestoThriftServicePrestoGetIndexSplitsResult) IsSetEx1() bool {
	return p.Ex1 != nil
}

func (p *PrestoThriftServicePrestoGetIndexSplitsResult) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *PrestoThriftServicePrestoGetIndexSplitsResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = &PrestoThriftSplitBatch{}
	if err := p.Success.Read(iprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Success), err)
	}
...
func (p *PrestoThriftServicePrestoGetIndexSplitsResult) ReadField1(iprot thrift.TProtocol) error {
	p.Ex1 = &PrestoThriftServiceException{}
	if err := p.Ex1.Read(iprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Ex1), err)
	}
...
func (p *PrestoThriftServicePrestoGetIndexSplitsResult) Write(oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin("prestoGetIndexSplits_result"); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err)
	}
	if p != nil {
		if err := p.writeField0(oprot); err != nil {
...
func (p *PrestoThriftServicePrestoGetIndexSplitsResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err := oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 0:success: ", p), err)
		}
...
func (p *PrestoThriftServicePrestoGetIndexSplitsResult) writeField1(oprot thrift.TProtocol) (err error) {
	if p.IsSetEx1() {
		if err := oprot.WriteFieldBegin("ex1", thrift.STRUCT, 1); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:ex1: ", p), err)
		}
...
func (p *PrestoThriftServicePrestoGetIndexSplitsResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("PrestoThriftServicePrestoGetIndexSplitsResult(%+v)", *p)
}
...
func (p *PrestoThriftServicePrestoGetRowsArgs) ReadField2(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Columns = append(p.Columns, _elem49)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
